...
libraries/hpm_sdk/soc/HPM6750/boot \
libraries/hpm_sdk/soc/HPM6750 \
...
packages/netutils-v1.3.2/ntp \
packages/onenet-latest/samples \
packages/onenet-latest/src \
packages/pahomqtt-v1.1.0/MQTTClient-RT \
packages/pahomqtt-v1.1.0/MQTTPacket/src \
packages/u8g2-official-latest/csrc \
packages/u8g2-official-latest/sys/rt-thread/port \
packages/webclient-latest/src \
...
rt-thread/libcpu/risc-v/hpmicro \
rt-thread/src \
startup/HPM6750 \
startup/HPM6750/toolchains/gcc \
