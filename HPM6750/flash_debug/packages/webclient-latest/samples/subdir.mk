...
C_SRCS += \
../packages/webclient-latest/samples/webclient_get_sample.c \
../packages/webclient-latest/samples/webclient_post_sample.c \
../packages/webclient-latest/samples/webclient_shard_download_sample.c 

OBJS += \
./packages/webclient-latest/samples/webclient_get_sample.o \
./packages/webclient-latest/samples/webclient_post_sample.o \
./packages/webclient-latest/samples/webclient_shard_download_sample.o 

C_DEPS += \
./packages/webclient-latest/samples/webclient_get_sample.d \
./packages/webclient-latest/samples/webclient_post_sample.d \
./packages/webclient-latest/samples/webclient_shard_download_sample.d 


# Each subdirectory must supply rules for building sources it contributes
packages/webclient-latest/samples/%.o: ../packages/webclient-latest/samples/%.c
